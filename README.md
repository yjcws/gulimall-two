...
> 考虑到分布式，比如模块设计端口为8000，那么多个微服务时就可以8001，8002..这样的端口
...
|   renren-generator   |         人人开源项目的代码生成器         |          |              |
| gulimall-auth-server | 认证中心（社交登录、OAuth2.0、单点登录） |          |              |
|    gulimall-cart     |                购物车服务                |          |  gulimall_   |
|   gulimall-coupon    |                优惠卷服务                |   7000   | gulimall_sms |
|   gulimall-gateway   |               统一配置网关               |    88    |              |
|    gulimall-order    |                 订单服务                 | 9000端口 | gulimall_oms |
|   gulimall-product   |                 商品服务                 |  10000   | gulimall_pms |
|   gulimall-search    |                 检索服务                 |          |  gulimall_   |
|   gulimall-seckill   |                 秒杀服务                 |          |  gulimall_   |
| gulimall-third-party |                第三方服务                |  30000   |  gulimall_   |
...
DROP DATABASE IF EXISTS  pms_catelog;
...
CREATE DATABASE IF NOT EXISTS gulimall_oms DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS gulimall_pms DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS gulimall_sms DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS gulimall_ums DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS gulimall_wms DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS  pms_catelog DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE DATABASE IF NOT EXISTS  sys_menus DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
